...
`<version>` below is the release version (e.g. `0.3.0`):
...
Download and install one — e.g. Linux x86_64, v0.3.0:

```sh
curl -LO https://github.com/cwilper/skimmd/releases/download/v0.3.0/skimmd-0.3.0-x86_64-unknown-linux-musl
chmod +x skimmd-0.3.0-x86_64-unknown-linux-musl
sudo mv skimmd-0.3.0-x86_64-unknown-linux-musl /usr/local/bin/skimmd
```
